...
if os.path.exists(MASTER_DB_PATH):
    try:
        ...
        print(f"✅ DB Loaded. Found {len(processed_folders)} processed folders.")
...
if not target_folders:
    print("\n🎉 All 'CollegeDoors' folders are already processed! Exiting.")
    exit()
...
for folder in tqdm(target_folders, desc="Processing Batches"):
    ...
    print(f"   ✅ Processed. Current ID reached: {current_global_id}")
...
if new_data_list:
    ...
    try:
        ...
        print(f"✅ DB Updated. Added {len(new_entries_df)} questions.")
