...
if __name__ == "__main__":
    ...
    FILE_NAME = "Allen NEET Physics Module.pdf" 
    CHAPTER_NAME = "Moving charges"
    START = 1030   # Starting page number (as seen in PDF viewer)
    END = 1041    # Ending page number (as seen in PDF viewer)
